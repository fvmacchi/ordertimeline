...
DECLARE @ITEMSDATA TABLE (
    ...
    it.ID_PZ, it.DELETED, it.ID_LOTTI, it.ORDINE, it.RIFCLI, it.ID_PERSONE, it.DATAINS, it.DATAORD, it.ORDINI_STATO, 
  ...
  SELECT * FROM @ITEMSDATA order by RIGA, PROGR, PRIOWORK--WHERE rn=1 ORDER BY DATACONS
